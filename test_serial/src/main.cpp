...
#define LOG(...)    USBSerial.print(__VA_ARGS__)
#define LOGLN(...)  USBSerial.println(__VA_ARGS__)
...
void setup() {
  ...
  LOGLN("micro-ROS: conector UART (CH343)  |  estos logs: conector USB nativo");

  // Abre el UART a 921600. A partir de aqui el puerto lleva tramas XRCE-DDS:
  // cualquier Serial.print lo corrompe.
  set_microros_transports();
  LOGLN("transporte abierto a 921600, esperando al agente...");
